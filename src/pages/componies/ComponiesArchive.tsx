...
export function ComponiesArchive() {
  ...
  const DATA = [
    {
      id: 1,
      image: require('assets/img/comp/2.png'),
    ...
    {
      id: 2,
      image: require('assets/img/comp/4.png'),
      title: 'آغاز ساخت دو فروند کشتی تانکر چند منظوره',
      date: '12-بهمن-1401',
      location: 'هرمزگان، بندرعباس',
      slug: 1
    ...
    {
      id: 3,
      image: require('assets/img/comp/3.png'),
      title: 'آغاز ساخت دو فروند کشتی تانکر چند منظوره',
      date: '12-بهمن-1401',
      location: 'هرمزگان، بندرعباس',
      slug: 1
    ...
    {
      id: 4,
      image: require('assets/img/comp/1.png'),
      title: 'آغاز ساخت دو فروند کشتی تانکر چند منظوره',
      date: '12-بهمن-1401',
      location: 'هرمزگان، بندرعباس',
      slug: 1
  ...
  const renderPosts = ({ item }) => {
    return (
      <Button
        onPress={() => navigator(navigation, 'ComponiesSingle', { slug: item.slug })}
        key={item.id}
            ...
            <Section style={styles.leftSection}>
              ...
              <Section style={styles.dateInfoContainer}>
                <Section style={styles.itemDateContainer}>
                  <Image source={STAR} style={{ ...styles.dateIcon, tintColor: EStyleSheet.value('$text.yellow') }} />
  ...
  return (
    <Section style={styles.container}>
      <Header title="نمایشگاه های دریایی" />
